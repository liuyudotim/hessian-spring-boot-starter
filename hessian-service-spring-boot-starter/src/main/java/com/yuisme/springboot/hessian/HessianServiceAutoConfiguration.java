 ...
 */
@Configuration
public class HessianServiceAutoConfiguration {
    private static final Logger logger = LoggerFactory.getLogger(HessianServiceAutoConfiguration.class);
    ...
    public static class AutoConfiguredHessianClientsScannerRegistrar
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
            ...
            logger.debug("Searching for hessian clients annotated with @HessianService");

            ClassPathHessianServiceScanner scanner = new ClassPathHessianServiceScanner(registry);
            ...
            try {
                ...
                scanner.setAnnotationClass(HessianService.class);
