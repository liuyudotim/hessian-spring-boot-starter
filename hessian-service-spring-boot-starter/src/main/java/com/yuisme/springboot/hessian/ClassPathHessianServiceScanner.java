 ...
 */
public class ClassPathHessianServiceScanner extends ClassPathBeanDefinitionScanner {

    private Class<? extends Annotation> annotationClass;
    private Class<?> markerInterface;

    public ClassPathHessianServiceScanner(BeanDefinitionRegistry registry) {
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            if (definition instanceof ScannedGenericBeanDefinition) {
                ...
                definition.getPropertyValues().addPropertyValue("service", serviceInterface);
            }
        }
    }
